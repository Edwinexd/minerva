...
// ---------------------------------------------------------------------------
// Auth helper (same pattern as LTI routes)
// ---------------------------------------------------------------------------
...
/// A file entry from the Canvas REST API.
...
/// Fetch the list of files in a Canvas course.
...
/// Download a file from Canvas by its download URL.
...
async fn create_connection(
    ...
    // Validate the token works by trying to list files.
...
// ---------------------------------------------------------------------------
// Canvas file listing (preview what's available)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Sync: pull files from Canvas and upload to Minerva
// ---------------------------------------------------------------------------
...
async fn trigger_sync(
    ...
    // Which files have we already synced?
    let already_synced =
    ...
    for file in &files {
        ...
        // Insert document record (pending processing).
