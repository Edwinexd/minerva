...
import { courseQuery, courseMembersQuery, courseDocumentsQuery, modelsQuery, allConversationsQuery, conversationDetailQuery, popularTopicsQuery, apiKeysQuery, ltiSetupQuery, ltiRegistrationsQuery, canvasConnectionsQuery, canvasFilesQuery } from "@/lib/queries"
...
import type { ApiKeyCreated, CanvasConnection, CanvasFileInfo, CanvasSyncResult, ConversationWithUser, Course, Document as DocType, LtiRegistration, TeacherNote } from "@/lib/types"
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="config">
        ...
        <TabsContent value="lti" className="mt-4">
          <LtiPanel courseId={courseId} />
        </TabsContent>

        <TabsContent value="canvas" className="mt-4">
          <CanvasPanel courseId={courseId} />
        </TabsContent>
...
function LtiPanel({ courseId }: { courseId: string }) {
  const queryClient = useQueryClient()
...
function CanvasPanel({ courseId }: { courseId: string }) {
  const queryClient = useQueryClient()
